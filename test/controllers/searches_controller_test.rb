...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference('Search.count') do
      post searches_url, params: { search: { Date: @search.Date, Type: @search.Type, raceName: @search.raceName } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { Date: @search.Date, Type: @search.Type, raceName: @search.raceName } }
