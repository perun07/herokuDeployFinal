...
class BlogPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blog_post" do
    assert_difference('BlogPost.count') do
      post blog_posts_url, params: { blog_post: { author: @blog_post.author, content: @blog_post.content, date: @blog_post.date, picture: @blog_post.picture, title: @blog_post.title } }
    end
  ...
  test "should update blog_post" do
    patch blog_post_url(@blog_post), params: { blog_post: { author: @blog_post.author, content: @blog_post.content, date: @blog_post.date, picture: @blog_post.picture, title: @blog_post.title } }
